...
class LinearWood(nn.Module):
  def __init__(self):
    ...
    self.conv1 = nn.Conv2d(in_channels=3, out_channels=5, kernel_size=7, stride=2, padding=0, dilation=1) #out 160
    self.maxpool1 = nn.MaxPool2d(kernel_size=7, stride=2, padding=0, dilation=1) # out 77

    self.conv2 = nn.Conv2d(in_channels=5, out_channels=9, kernel_size=7, stride=2, padding=0, dilation=1) # out 36
    self.maxpool2 = nn.MaxPool2d(kernel_size=5, stride=2, padding=0, dilation=1) # out 16

    self.conv3 = nn.Conv2d(in_channels=9, out_channels=18, kernel_size=5, stride=2, padding=0, dilation=1) # out 6
    self.conv4 = nn.Conv2d(in_channels=18, out_channels=36, kernel_size=3, stride=1, padding=0, dilation=1) # out 4
    self.conv5 = nn.Conv2d(in_channels=36, out_channels=64, kernel_size=3, stride=1, padding=0, dilation=1) # out 2
    self.conv6 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=2, stride=1, padding=0, dilation=1) # out 1
